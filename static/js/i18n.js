...
(() => {
  ...
  'ui.languageLabel': 'Language / Sprache:',
      ...
      'tutorial.next': 'Next',
      'tutorial.slides': [
        "<b>Welcome to Whack-an-Error!</b><br><br>This is a game about quantum error correction. Your goal is to find and correct errors in a lattice of qubits.<br><img src='static/tutorial_1.png' style='width:80%;margin-top:12px;'>",
        "Each round, some qubits have errors. Use your shovel to flip qubits and try to turn all sensors off.<br><img src='static/tutorial_2.png' style='width:80%;margin-top:12px;'>",
        "Sensors indicate whether there are errors nearby. If all sensors are off, you've removed all detectable errors.<br><img src='static/tutorial_3.png' style='width:80%;margin-top:12px;'>",
        "Beware! If you remove all syndromes but a logical error remains, you lose the round.<br><b>Logical error:</b> an error undetected by the sensors that changes the encoded information.<br><img src='static/tutorial_4.png' style='width:80%;margin-top:12px;'>",
        "In playground mode, you can set errors manually and observe the effects directly.<br><img src='static/tutorial_5.png' style='width:80%;margin-top:12px;'>",
        "Try to eliminate all errors without causing a logical one. Advance through levels for more challenge!<br>Good luck!<br><img src='static/tutorial_6.png' style='width:80%;margin-top:12px;'>"
      ]
    }
  };
