...
(() => {
  ...
  'buttons.download': 'Daten herunterladen',
  'buttons.delete': 'Daten löschen',
  ...
  'stats.confirmDelete': 'Alle lokalen Daten löschen? Dies kann nicht rückgängig gemacht werden.',
  ...
  'ui.languageLabel': 'Sprache / Language:',
    ...
    en: {
      ...
      'buttons.reset': 'Reset',
      'buttons.close': 'Close',
  'buttons.download': 'Download dataset',
  'buttons.delete': 'Delete dataset',
  ...
  'stats.confirmDelete': 'Delete all local data? This cannot be undone.',
